...
public class MultiUserChatServerHandler extends Thread implements ProtocolHandler {
    ...
    private RoomRev1 roomRev1;
    public MultiUserChatServerHandler(Socket connectionSocket, RoomRev1 roomRev1) throws IOException {
        this.chatSocket = connectionSocket;
        this.roomRev1 = roomRev1;
        roomRev1.add(chatSocket);   // Registro la socket di connessione all'interno di room
    }
    ...
    public void run() {
        try {
            ...
            roomRev1.showRoomToClients(chatSocket);
            ...
            do {
                ...
                roomRev1.broadCast(chatSocket ,!end ? line : line.substring(0, line.lastIndexOf(".")));
            }while (!end);
            /**
